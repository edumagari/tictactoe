    ...
    <AuthenticatedLayout>
        ...
        <ul class="max-w-sm mx-auto mt-6 space-y-2">
            <li class="flex items-center">
                <span class="p-1.5 font-bold roudned bg-gray-200" :class="{ 'bg-green-200': xTurn }">X</span>
            ...
            <li v-if="game.player_two" class="flex items-center">
                <span class="p-1.5 font-bold roudned bg-gray-200" :class="{ 'bg-green-200': ! xTurn }">O</span>
        ...
        <Modal @close="resetGame()" :show="gameState.hasEnded()">
            <div class="p-6">
                <div class="text-6xl font-bold text-center my-12 font-mono uppercase">
                    ...
                    <span v-else class="text-green-600">Stalemate!</span>
                </div>
